...
class RettighetstypeMapperTest {
    ...
    fun ` test mapping av henvendelse til rettighetstype Perm`() {
        assertEquals(Rettighetstype.DAPENGER_UNDER_PERMITERING, RettighetstypeMapper.mapper.getRettighetstype("NAV 04-01.04"))
        assertEquals(Rettighetstype.DAPENGER_UNDER_PERMITERING, RettighetstypeMapper.mapper.getRettighetstype("NAV 04-16.04"))
        assertEquals(Rettighetstype.DAPENGER_UNDER_PERMITERING, RettighetstypeMapper.mapper.getRettighetstype("NAVe 04-01.04"))
        assertEquals(Rettighetstype.DAPENGER_UNDER_PERMITERING, RettighetstypeMapper.mapper.getRettighetstype("NAVe 04-16.04"))
    }
